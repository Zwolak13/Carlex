...
const CarComponent: React.FC<CarComponentProps> = ({ 
  ...
  const gradientIdA = `gradient-a-${idSuffix}`;
  const gradientIdB = `gradient-b-${idSuffix}`;
    ...
    >
      <defs>
        ...
        <radialGradient
          ...
          gradientUnits="userSpaceOnUse"
        />
        <linearGradient id={gradientIdA}>
          <stop offset={0} stopColor={colorP} />
          <stop offset={1} stopColor={colorS} />
        </linearGradient>
        <linearGradient id={gradientIdB}>
          <stop offset={0} stopColor={colorS} />
          <stop offset={1} stopColor={colorP} />
        </linearGradient>
      </defs>
      ...
      <g fill="#4a00ad">
        ...
        <path d="M168.107 50.46c.185-1.319.092-2.71.101-4.034.013-2.644.014-5.287-.007-7.931-.014-1.751-.032-3.502-.037-5.253-.001-1.047.002-2.096.005-3.143h3.872c.002 1.047.006 2.096.003 3.143-.003 1.751-.022 3.502-.036 5.253a620.065 620.065 0 0 0-.008 7.93c.01 1.325-.084 2.716.103 4.036h-3.996zM153.19 52.26c.219-1.706.114-3.502.134-5.217.046-4.31.051-8.621.008-12.932a543.435 543.435 0 0 0-.066-4.234h3.275a597.778 597.778 0 0 0-.066 4.234c-.043 4.311-.037 8.622.008 12.932.021 1.715-.085 3.511.134 5.217h-3.427z" />
      ...
      <path
        fill="#000000"
        fillRule="evenodd"
        d="m41.537 281.88 21.534 82.442s0 154.58-3.076 157.15c-3.077 2.576-27.686 46.372-27.686 46.372s6.152-280.81 9.229-285.97z"
      />
      <path
        fill="#000000"
        fillRule="evenodd"
        d="m318.84 276.88-21.534 82.442s0 154.58 3.076 157.15c3.077 2.576 27.686 46.372 27.686 46.372s-6.152-280.81-9.229-285.97z"
      />
      ...
      <path
        ...
        strokeOpacity={0.553}
        strokeWidth={1.25}
        d="m321.9 279.09 28.348 2.362s14.174 14.174 4.725 21.261c-9.45 7.087-33.073-2.362-33.073-2.362V279.09z"
      />
      <path
        fill={colorS}
        fillRule="evenodd"
        ...
        strokeOpacity={0.547}
        strokeWidth="1pt"
        d="m36.946 283.82-28.348 2.362s-14.174 14.174-4.725 21.261c9.45 7.087 33.073-2.362 33.073-2.362V283.82z"
      />
      ...
      <path
        ...
        stroke="#000"
        strokeWidth="1pt"
        d="m43.148 295.63 16.536 75.595s0 141.74-2.362 144.1c-2.363 2.362-21.261 42.521-21.261 42.521s4.724-257.49 7.087-262.22z"
      />
      <path
        fill="none"
        stroke="#000"
      ...
      <path
        ...
        stroke="#000"
        strokeWidth="1pt"
        d="m317.18 290.91-16.536 75.595s0 141.74 2.362 144.1c2.363 2.362 21.261 42.521 21.261 42.521s-4.724-257.49-7.087-262.22z"
      />
    </svg>
  );
};
